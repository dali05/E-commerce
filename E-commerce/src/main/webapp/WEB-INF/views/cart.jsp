...
<c:choose>
	<c:when test="${not empty cartLines}">
	    <table id="cart" class="table table-hover table-condensed">
						...
						<tr>
							<td data-th="Product">
								<div class="row">
									...
									<img src="${images}/${cartLine.product.code}.jpg" alt="${cartLine.product.name}" style="width: 100px;height: 100px" class="img-fluid"/></div>
									<div class="col-sm-10">
					...
					<tfoot>
<!-- 						<tr class="visible-xs"> -->
<%-- 							<td class="text-center"><strong>Total ${userModel.cart.grandTotal} dt </strong></td> --%>
<!-- 						</tr> -->
						<tr>
							<td><a href="#" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a></td>
							<td colspan="2" class="hidden-xs"></td>
							<td class="hidden-xs text-center"><strong>Total ${userModel.cart.grandTotal} dt</strong></td>
